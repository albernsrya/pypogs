...
try:
    ...
    sys.alignment.set_location_lat_lon(
        lat=52.2155, lon=4.4194, height=45)  # ESTEC football field (0m MSL)
    ...
    sys.coarse_track_thread.image_folder = Path(
        r"C:\Users\gustav pettersson\Desktop\11th observing\imgsavefolder")
    ...
    sys.fine_camera.plate_scale = 0.30
    ...
    sys.fine_track_thread.image_folder = Path(
        r"C:\Users\gustav pettersson\Desktop\11th observing\imgsavefolder")
